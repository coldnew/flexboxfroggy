var levels = [
  {
    ...
    instructions: {
      ...
      'zh-tw': '<p>歡迎來到Flexbox Froggy。在遊戲中你會靠寫CSS程式碼來幫助青蛙和他的朋友們! 請用<code>justify-content</code>屬性指引青蛙到右邊的荷葉上。這個屬性可以水平對齊元素，並且接受以下幾個參數：</p><ul><li><code>flex-start</code>: 元素和容器的左端對齊。</li><li><code>flex-end</code>: 元素和容器的右端對齊。</li><li><code>center</code>: 元素在容器里置中。</li><li><code>space-between</code>:元素之間保持相等的距離。</li><li><code>space-around</code>:元素周圍保持相等的距離。</li></ul><p>舉個例子，<code>justify-content: flex-end;</code>會將青蛙移到右邊</p>',
  ...
  },
  {
    ...
    instructions: {
      ...
      'zh-tw': '<p>再用<code>justify-content</code>一次來幫助這些青蛙到他們的荷葉上。記住這個CSS屬性能水平對齊元素，並接受這些參數：</p><ul><li><code>flex-start</code>: 元素和容器的左端對齊。</li><li><code>flex-end</code>: 元素和容器的右端對齊。</li><li><code>center</code>: 元素在容器里置中。</li><li><code>space-between</code>:元素之間保持相等的距離。</li><li><code>space-around</code>:元素周圍保持相等的距離。</li>',
  ...
  },
  {
    ...
    instructions: {
      ...
      'zh-tw': '<p>只使用<code>justify-content</code>來幫助全部三隻青蛙找到他們的荷葉。這次荷葉周邊都有很多的空地。</p><p>如果你忘了一个CSS屬性可用的數值的話，你可以將游標移到屬性名稱上面來查看。試試將游標移到<code>justify-content</code>。</p>',
  ...
  },
  {
    ...
    instructions: {
      ...
      'zh-tw': '<p>現在邊上的荷葉都漂到了岸上，使得他們之間的距離變大了。使用<code>justify-content</code>讓荷葉之間有相等的距離。</p>',
